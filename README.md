...
Fluxon.Endpoint.run_server(<Fluxon.Endpoint.Server object>) is responsible for starting the server. Just run server.py—the instance is already passed to run_server.
